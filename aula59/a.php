...
ter o seu código "partido"  entre diferentes ficheiros. Salvo raras excepções,
um projeto terá dezenas ou centenas de ficheiros para que a aplicação funcione
