...
A diferença entre o include e o require é que, no caso do include falhar, o
código avança com um aviso
...
É aconselhável o uso do require, uma vez que, acontecendo um erro de importação
do script, a aplicação não irá avançar com erros
*/